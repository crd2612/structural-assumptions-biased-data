##############################################################
# Script: 5.4) Plot target variable living_space under bias
#
# Description:
# This script visualizes the induced bias across sigma levels
# based on the distribution of living_space in training and test sets.
##############################################################
...
ggplot(viz_df,
       aes(x = Value, y = Draw,
           ...
           linetype = Group,
           alpha = Group)) +
  geom_density_ridges(scale = 2, rel_min_height = 0.01, size = 0.4) +
  ...
  labs(
    title = "Density of Living Space across Sigma Levels",
    x = "Living space (sqm)",
    y = "",
    fill = "Sigma",
    color = "Group",
