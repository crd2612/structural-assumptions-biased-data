...
##############################################################
# Script:5.2) Plot biased Variable hh_net_income
#
# Description:
# This script visualizes the induced bias across sigma levels based on the distribution
# of hh_net_income in training and test sets.
##############################################################
...
ggplot(viz_df,
  ...
  labs(
    title = "Density of Household Net Income across Sigma Levels",
